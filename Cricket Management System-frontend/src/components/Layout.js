...
function Layout({ children, onLogout }) {
  ...
  return (
    ...
    <NavDropdown.Item as={Link} to="/admin/Grounds">Manage Grounds</NavDropdown.Item>
  </NavDropdown>
  )}
  {user && user.role === 'ROLE_PLAYER' && (
    <NavDropdown title="Player Dashboard" id="player-dashboard-dropdown">
    <NavDropdown.Item as={Link} to="/player/training_sessions">Training Sessions</NavDropdown.Item>
  </NavDropdown>
  )}
            </Nav>
            <Nav>
