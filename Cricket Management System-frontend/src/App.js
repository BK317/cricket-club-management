      ...
      <Router>
        <Layout user={user} onLogout={handleLogout}>
          <Routes>
            ...
            <Route path="/admin" element={user?.role === 'ROLE_ADMIN' ? <AdminDashboard></AdminDashboard>  : <Navigate to="/" />} />
            ...
            <Route path="/admin/Grounds" element={<GroundManagement />} />
            <Route path="/player/training_sessions" element={<TrainingSessionManagement/>} />
            <Route
              path="/profile"
